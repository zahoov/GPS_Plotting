...
class NMEAParser():
    ...
    def methodTimestamp(self, rawStamp: str) -> datetime.time:
        ...
        minute = int(rawStamp[2:4])
        seconds = int(rawStamp[4:6])

        timestamp = datetime.time(hour, minute, seconds)
        return timestamp

    def methodDate(self, rawDate: str) -> datetime.date:
